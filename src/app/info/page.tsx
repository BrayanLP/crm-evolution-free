...
import { LayoutGrid, Users, Settings, PieChart, Search, Briefcase, Plus, RefreshCw, Pencil, Trash2, Info as InfoIcon, AlertTriangle, FileText, Smartphone } from 'lucide-react';
...
export default function InfoPage() {
  const { info, isSyncingInfo, syncInfo, createInfo, updateInfo, deleteInfo, isLoaded, accounts, activeAccount, setActiveAccountId } = useLeads();
