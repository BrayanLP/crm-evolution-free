...
const INITIAL_LEADS: Lead[] = [
  {
    ...
    company: 'TechCorp',
    stage: 'new',
    notes: 'Interested in our enterprise plan. Needs a demo by next Tuesday.',
  ...
  },
  {
    ...
    email: 'jane@innolabs.io',
    phone: '555-0102',
    company: 'Innovation Labs',
    stage: 'contacted',
    notes: 'Followed up via email. Waiting for a response regarding pricing.',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
];
